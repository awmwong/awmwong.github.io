...
<html>
  <head>
    ...
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-28698808-1']);
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="card">
        ...
        <ul>
          ...
          <li><a href="http://facebook.com/awmwong" class="facebook" title="Facebook">Facebook</a></li>
          <li><a href="http://twitter.com/wong" class="twitter" title="Twitter">Twitter</a></li>
          <li><a href="http://plus.google.com/109350295993730275387/" class="gplus" title="Google+">Google+</a></li>
    ...
    <footer>
    &copy; <?php echo date('Y'); ?>, Anthony Wong. Designed with <a href="http://twitter.com/timothya">@timothya</a>
    </footer>
